...
${OBJECTDIR}/ConfigurationManager.o: ConfigurationManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I../../../cuckoofilter/src -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ConfigurationManager.o ConfigurationManager.cpp

${OBJECTDIR}/DevicePCAPOffline.o: DevicePCAPOffline.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I../../../cuckoofilter/src -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DevicePCAPOffline.o DevicePCAPOffline.cpp

${OBJECTDIR}/DynWarden.o: DynWarden.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
...
${OBJECTDIR}/NormalizeManager.o: NormalizeManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I../../../cuckoofilter/src -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NormalizeManager.o NormalizeManager.cpp

${OBJECTDIR}/SamplingManager.o: SamplingManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I../../../cuckoofilter/src -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SamplingManager.o SamplingManager.cpp

${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I../../../cuckoofilter/src -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
