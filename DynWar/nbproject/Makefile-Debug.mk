...
${OBJECTDIR}/IODevice.o: nbproject/Makefile-${CND_CONF}.mk IODevice.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../../cuckoofilter/src -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IODevice.o IODevice.cpp
